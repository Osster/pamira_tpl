            ...
            <div class="row">
                <? foreach ($arResult["ITEMS"] as $key => $arItem)//prices
                {
                    ...
                    if (isset($arItem["PRICE"])):
                        ...
                        ?>
                        <div class="<?
                        if ($arParams["FILTER_VIEW_MODE"] == "HORIZONTAL"):?>col-sm-6 col-md-4<? else: ?>col-12<? endif ?> bx-filter-parameters-box bx-active">
                            ...
                            <div class="bx-filter-block" data-role="bx_filter_block">
                                <div class="row bx-filter-parameters-box-container">
                                    ...
                                    <div class="col-6 form-group">
                                        <label for="<?
                                        echo $arItem["VALUES"]["MIN"]["CONTROL_ID"] ?>"><?= GetMessage("CT_BCSF_FILTER_FROM") ?></label>
                                    ...
                                    <div class="col-6 form-group">
                                        <label for="<?
                                        echo $arItem["VALUES"]["MAX"]["CONTROL_ID"] ?>"><?= GetMessage("CT_BCSF_FILTER_TO") ?></label>
                                        <div class="bx-filter-input-container">
                                            <input
                                    ...
                                    <div class="col">
                                        ...
                                        foreach ($arItem["VALUES"] as $val => $ar):?>
                                            <div class="form-check">
                                                ...
                                                />
                                                <label data-role="label_<?= $ar["CONTROL_ID"] ?>"
                                                       class="form-check-label" for="<? echo $ar["CONTROL_ID"] ?>">
                                                    <?= $ar["VALUE"]; ?><?
                                                    if ($arParams["DISPLAY_ELEMENT_COUNT"] !== "N" && isset($ar["ELEMENT_COUNT"])):
                                                        ?>&nbsp;(<span
                                                            data-role="count_<?= $ar["CONTROL_ID"] ?>"><? echo $ar["ELEMENT_COUNT"]; ?></span>)<?
