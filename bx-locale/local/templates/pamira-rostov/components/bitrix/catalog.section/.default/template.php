...
<div class="catalog-section <?= ($SECTION_VIEW_TYPE == 'card') ? 'catalog-plitka' : 'catalog-list'?>" data-entity="<?=$containerName?>">
    <div class="row">
	<?
	if (!empty($arResult['ITEMS']) && !empty($arResult['ITEM_ROWS']))
	{
		...
		foreach ($arResult['ITEM_ROWS'] as $rowData)
		{
			...
			?>
                ...
                {
                    ?>
                    <div class="col-12 p-1 <?= ($SECTION_VIEW_TYPE == 'card') ? 'col-md-4' : '' ?>" data-entity="items-row">
                        <?
