...
<script id="basket-item-template" type="text/html">
    <div class="row basket__product" id="basket-item-{{ID}}" data-entity="basket-item" data-id="{{ID}}">
        {{#SHOW_RESTORE}}
        ...
        <div class="col-12 col-md-5">
            <div class="d-flex" id="basket-item-height-aligner-{{ID}}">
                ...
                {
                ?>
                <div class="basket__product_img <?= (!isset($mobileColumns['PREVIEW_PICTURE']) ? ' hidden-xs' : '') ?>">
                    {{#DETAIL_PAGE_URL}}
