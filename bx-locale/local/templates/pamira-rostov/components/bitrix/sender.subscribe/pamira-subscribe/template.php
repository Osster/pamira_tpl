...
?>
<div class="row bx-subscribe" id="sender-subscribe">
    <!--
    ...
    <form id="bx_subscribe_subform_<?=$buttonId?>" role="form" method="post" action="<?=$arResult["FORM_ACTION"]?>">
        ...
        <div class="col-12 col-lg-6 col-xl-7 bx-input-group">
            <input class="bx-form-control email" type="email" name="SENDER_SUBSCRIBE_EMAIL" value="<?=$arResult["EMAIL"]?>" title="<?=GetMessage("subscr_form_email_title")?>" placeholder="<?=htmlspecialcharsbx(GetMessage('subscr_form_email_title'))?>">
        </div>
        ...
        <div class="col-12 col-lg-6 col-xl-5 bx_subscribe_submit_container">
            <button class="sender-btn btn-subscribe btn btn-hover_black form-news__btn" id="bx_subscribe_btn_<?=$buttonId?>"><span><?=GetMessage("subscr_form_button")?></span></button>
        </div>
    </form>
    <?
    $frame->beginStub();
