...
<? $APPLICATION->IncludeComponent(
    ...
    Array(
        ...
        "AJAX_OPTION_JUMP" => "N",
        "AJAX_OPTION_STYLE" => "Y",
        "BLOCK_SECTION_ONE" => "174",
        "BLOCK_SECTION_THREE" => "176",
        "BLOCK_SECTION_TWO" => "175",
        "BROWSER_TITLE" => "-",
        "CACHE_FILTER" => "N",
        "CACHE_GROUPS" => "Y",
        "CACHE_TIME" => "36000000",
        ...
        "LIST_FIELD_CODE" => array("ID", "NAME", "PREVIEW_TEXT", "DETAIL_TEXT", "DETAIL_PICTURE", "IBLOCK_ID", "IBLOCK_CODE", ""),
